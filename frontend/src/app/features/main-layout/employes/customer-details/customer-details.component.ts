...
import { AccountCardListComponent } from '../../../../shared/components/account/account-card-list/account-card-list.component';
...
export class CustomerDetailsComponent {
  ...
  private loadCustomerInfosWithAccounts(customerId: string): void {
    this.clientService.findDetailsClientWithAccount(customerId).subscribe({
